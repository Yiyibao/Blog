Create Codex pet row `running-left` for `xinn-hd-final`: exactly 8 full-body frames in one horizontal strip on flat pure user-selected #00FF00.

Use the attached canonical base for identity and the layout guide only for spacing. Same pet in every frame: 保持现有 Xinn 的 Q 版古风小仕女身份：圆润脸型、大眼睛、黑色高髻、金色发冠、橙黄色花饰与两侧流苏，金橙色宽袖披帛、白蓝长裙、金色系带与绣鞋。网站以 307px 宽显示，细节必须在该尺寸清楚。. Preserve silhouette, face, palette, material, proportions, markings, and props.
