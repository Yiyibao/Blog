...
<template>
  <div class="footer-info">
    ...
    <p v-if="hasIcp" class="footer-icp">
      <a v-if="cfg.icpLink" :href="cfg.icpLink" target="_blank" rel="noopener noreferrer">{{
        cfg.icpRecord
      }}</a>
      <span v-else>{{ cfg.icpRecord }}</span>
    </p>
    <p v-if="hasPolice" class="footer-police">
      <a v-if="cfg.policeLink" :href="cfg.policeLink" target="_blank" rel="noopener noreferrer">{{
        cfg.policeRecord
      }}</a>
