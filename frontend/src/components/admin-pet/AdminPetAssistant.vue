      ...
      <header class="pet-chat-header">
        ...
        <div
          v-if="
            ...
            ai.modelOptions.length > 1 ||
            (ai.providers.length && ai.reasoningSupported)
          "
          class="pet-chat-switchers"
        >
          <select
          ...
          <select
            ...
            @change="
              ai.selectReasoningEffort(($event.target as HTMLSelectElement).value as AiReasoningSelection)
            "
          >
