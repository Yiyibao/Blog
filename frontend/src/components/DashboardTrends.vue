...
.inspiration-panel > header strong {
  color: var(--ink);
  font:
    500 20px Georgia,
    'Noto Serif SC',
...
.inspiration-panel > header span {
  color: var(--muted);
  font-size: 11px;
}
.inspiration-panel :deep(.inspiration-calendar-widget) {
  display: flex;
  flex: 1;
  align-items: center;
}
.inspiration-panel :deep(.calendar-card) {
  max-width: 360px;
}
.trend-chart-card {
  grid-area: trend;
