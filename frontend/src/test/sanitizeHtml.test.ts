...
describe('NF-2 文章正文前端消毒', () => {
  ...
  it('保留 TOC 所需的标题 id 与常规排版标签', () => {
    const input =
      '<h2 id="section-1">章节</h2><pre><code class="language-ts">const a = 1</code></pre><ul><li>项</li></ul>';
  ...
  it('保留图片与安全链接', () => {
    const out = sanitizeHtml(
      '<img src="/api/v1/note-assets/abc.png" alt="图"><a href="https://example.com">外链</a>',
    );
