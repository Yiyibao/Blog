    ...
    SecurityFilterChain securityFilterChain(HttpSecurity http, JwtAuthenticationConverter jwtConverter,
        ...
        return http
            ...
            .authorizeHttpRequests(auth -> auth
                ...
                .requestMatchers(HttpMethod.GET, "/api/v1/dish-assets/**", "/api/v1/posts/**", "/api/v1/categories", "/api/v1/categories/**", "/api/v1/dish-categories", "/api/v1/dish-categories/**", "/api/v1/dishes/**", "/api/v1/search", "/api/v1/music/**", "/api/v1/graph/**", "/api/v1/quotes/**", "/api/v1/series/**", "/api/v1/tags/**").permitAll()
