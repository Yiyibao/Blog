...
public class FlywayMigrationConfig {
    ...
    @Bean
    public FlywayConfigurationCustomizer migrationCompatibilityCustomizer() {
        return configuration -> configuration.callbacks(new LegacyDishAssetMigrationCallback());
    }
