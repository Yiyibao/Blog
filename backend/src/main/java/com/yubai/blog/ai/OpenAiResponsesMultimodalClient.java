    ...
    private static List<Map<String, Object>> toolDefinitions() {
        return List.of(
                ...
                Map.of(
                        ...
                        "function",
                        "name",
                        "propose_graph_relation",
                        "description",
                        "Suggest one graph relation for human approval; never writes directly.",
                        "parameters",
                        Map.of(
                                "type",
                                "object",
                                ...
                                false,
                                "required",
                                List.of("sourceId", "targetId", "relationType"),
                                "properties",
                                Map.of(
                                        "sourceId", Map.of("type", "string", "maxLength", 128),
                                        "targetId", Map.of("type", "string", "maxLength", 128),
                                        "relationType",
